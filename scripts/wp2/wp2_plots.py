...
def visualize_its_wl_iterations(
    ...
    *,
    ...
    G = rsmi_to_its(rsmi, drop_non_aam=False, use_index_as_atom_map=False)
...
def plot_its_wl_feature_growth_from_rsmi(
    ...
    *,
    ...
    per_iter, _total = its_wl_feature_sets(
        rsmi=rsmi,  
        h=h,
        mode=mode,
        include_edge_labels_in_sp=include_edge_labels_in_sp,
...
def plot_feature_growth_subset_its_vs_drf(
    ...
    *,
    ...
    for rsmi in df[rxn_col].astype(str):
        ...
        its_per_iter, _total = its_wl_feature_sets(
            rsmi=rsmi,  
            h=h,
            mode=mode,
            include_edge_labels_in_sp=include_edge_labels_in_sp,
